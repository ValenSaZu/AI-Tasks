...
struct Edge {
    int destination; // �ndice del nodo de destino
...
struct Node {
    ...
    int heuristic;           // valor de la heur�stica
...
public:
	...
	//TODO: implementar la generaci�n de aristas para que guarde en su heuristica a cuantos nodos est� conectado
