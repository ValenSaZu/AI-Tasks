// This file defines the DataLoader class, which is responsible for reading the CIFAR-10 dataset from binary files. 
// It includes methods for loading training and test data, as well as retrieving batches of data for training.
